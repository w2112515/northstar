...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DxHFP8am.mjs");
...
var manifest = {
	"5bf034e4641cedd73c6ce3c521b09db21af945d1c206af139e07ffc2eb9b655c": {
		functionName: "loadTape_createServerFn_handler",
		importer: () => import("./tape-D-U-j-xi.mjs")
	},
	"ea85f041eb176546f6570a7449242accf0013febf7c88a0ff0346777b9014cff": {
		functionName: "searchTape_createServerFn_handler",
		importer: () => import("./tape-D-U-j-xi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Byr47Ah9.mjs").then((n) => n.t),
